...
const Header = () => {
  ...
  <Container>
    <Navbar.Brand style={{height : "50px", MaxWidth: "400px"}} href="#home"><img  style={{height:"100%", width: "100%", borderRadius: "20px"}} src='https://1000logos.net/wp-content/uploads/2020/08/Shopify-Logo.jpg' alt
     /></Navbar.Brand>
