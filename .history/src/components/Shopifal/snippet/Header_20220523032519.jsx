 ...
 <>
  ...
  <Container>
    ...
    <Navbar.Collapse id="responsive-navbar-nav">
        ...
        <NavLink className="style_none" to="/home">Home</NavLink>
        <NavLink className="style_none" to="/product">Shop Now</NavLink>
        ...
        <Nav>
            <NavLink className="style_none" to="/dashboard">Account</NavLink>
            <NavLink className="style_none" to="/signup">Sign Up</NavLink>
            <NavLink className="style_none" eventKey={2} to="/login">Login</NavLink>
        </Nav>
    </Navbar.Collapse>
  </Container>
</Navbar>
