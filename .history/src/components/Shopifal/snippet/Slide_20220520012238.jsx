...
import Sliderstyle from '../assets/Slider.style.css'

const Slider = () => {
    return (
        <div>
            <Carousel variant="dark" className={Sliderstyle.slider_wrapper} >
            <Carousel.Item>
                    <img
                ...
                <Carousel.Item className={Sliderstyle.height_width_full}>
                    <img
                    className="d-block w-100"
